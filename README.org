...
** Alternatives
    In addtion to the forks here on github, there's a version on
    Codeberg by [[https://codeberg.org/pkal/ngnk-mode][pkal]] with some pretty heavy changes you might want to
    try out.
